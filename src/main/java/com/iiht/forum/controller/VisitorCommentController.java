...
public class VisitorCommentController 
{
	...
	public ResponseEntity<VisitorCommentsDto> deleteVisitorComment(@PathVariable("commentId") Long commentId) {
		return null;
	}	
	//------------------------------------------------------------------------------------------------
	@GetMapping(value = "/getCommentById/{commentId}")
	public ResponseEntity<VisitorCommentsDto> getVisitorByCommentId(@PathVariable("commentId") Long commentId) {
		return null;
	}
	//------------------------------------------------------------------------------------------------
	@GetMapping(value = "/getAllCommentsOfPost/{postId}")
	public ResponseEntity<List<VisitorCommentsDto>> getAllVisitorComments(@PathVariable("postId") Long postId) {
		return null;
	}
