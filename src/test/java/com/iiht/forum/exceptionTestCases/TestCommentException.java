...
public class TestCommentException 
{
	...
	public void testCommentNotFoundException() throws Exception
	{
		...
		Mockito.when(commentService.getCommentById(2L)).thenReturn(null);
				
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/comment/getCommentById/2")
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	public void testDeleteCommentException() throws Exception
	{
		...
		Mockito.when(commentService.deleteCommentById(2L)).thenReturn(null);
				
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/comment/delete/2")
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
