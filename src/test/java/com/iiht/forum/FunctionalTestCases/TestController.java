...
{	
	...
	{ 
		...
		yakshaAssert(currentTest(),	
					result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(postdto))? true : false, 
							businessTestFile);
	}
	//-- BDD Test : addPost -------------------------------------------------------------------
	@Test
	...
	@Test 
	public void testFindAllPostsBDD() throws Exception 
	{ 
		final int count[] = new int[1];
		List<VisitorPostsDto> list = new ArrayList<VisitorPostsDto>();
		list.add(MasterData.getPostDtoDetails());
		
		Mockito.when(postService.getAllPosts()).then(new Answer<List<VisitorPostsDto>>() {

			@Override
			public List<VisitorPostsDto> answer(InvocationOnMock invocation) throws Throwable {
				// TODO Auto-generated method stub
				count[0]++;
				return list;
			}
	...
	@Test 
	public void testFindAllPostsByAuthor() throws Exception 
	{ 
		List<VisitorPostsDto> list = new ArrayList<VisitorPostsDto>();
		String author = MasterData.getPostDtoDetails().getAuthor();
		list.add(MasterData.getPostDtoDetails());
		
		Mockito.when(postService.getAllPostOfAuthor(author)).thenReturn(list);
	
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/visitorPost/getPostByAuthor/" + author)
				.content(MasterData.asJsonString(MasterData.getPostDtoDetails()))
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	@Test 
	public void testFindAllPostsByAuthorBDD() throws Exception 
	{ 
		final int count[] = new int[1];
		String author = MasterData.getPostDtoDetails().getAuthor();
		List<VisitorPostsDto> list = new ArrayList<VisitorPostsDto>();
		...
		Mockito.when(postService.getAllPostOfAuthor(author)).then(new Answer<List<VisitorPostsDto>>() {
	...
	public void testDeleteComment() throws Exception
	{
		...
		Mockito.when(commentService.deleteCommentById(commentId)).thenReturn(commentDto);
		
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/comment/delete/" + commentId)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);				
	...
	public void testdeleteCommentBDD() throws Exception 
	{
		...
		Mockito.when(commentService.deleteCommentById(commentId)).then(new Answer<VisitorCommentsDto>() {
			@Override
			public VisitorCommentsDto answer(InvocationOnMock invocation) throws Throwable {
				// TODO Auto-generated method stub
				System.out.println("Called");
	...
	public void testFindCommentById() throws Exception
	{
		...
		Mockito.when(commentService.getCommentById(commentId)).thenReturn(commentDto);
		
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/comment/getCommentById/" + commentId)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	public void testFindCommentByIdBDD() throws Exception 
	{
		...
		Mockito.when(commentService.getCommentById(commentId)).then(new Answer<VisitorCommentsDto>() {
			@Override
			public VisitorCommentsDto answer(InvocationOnMock invocation) throws Throwable {
				// TODO Auto-generated method stub
				System.out.println("Called");
	 ...
	 */
	@Test 
	public void testFindAllCommentsOfPost() throws Exception 
	{
		List<VisitorCommentsDto> list = new ArrayList<VisitorCommentsDto>();
		list.add(MasterData.getCommentDtoDetails());
		Long postId = MasterData.getCommentDtoDetails().getPostId();
		
		Mockito.when(commentService.getAllCommentsofPost(postId)).thenReturn(list);
				RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/comment/getAllCommentsOfPost/" + postId)
				.content(MasterData.asJsonString(MasterData.getPostDtoDetails()))
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	@Test 
	public void testFindAllCommentsOfPostBDD() throws Exception 
	{
		final int count[] = new int[1];
		List<VisitorCommentsDto> list = new ArrayList<VisitorCommentsDto>();
		list.add(MasterData.getCommentDtoDetails());
		...
		Mockito.when(commentService.getAllCommentsofPost(postId)).then(new Answer<List<VisitorCommentsDto>>() {

			@Override
			public List<VisitorCommentsDto> answer(InvocationOnMock invocation) throws Throwable {
				// TODO Auto-generated method stub
				count[0]++;
				return list;
			}
